...
export default function ProfileSection() {
  ...
  return (
    <section
      ...
      className="relative isolate overflow-hidden px-section-x pb-20 pt-4 sm:pt-6 md:pb-24 lg:pb-28 lg:pt-8"
    >
      ...
      <motion.a
        ...
        className="mx-auto mt-20 flex h-10 w-10 items-center justify-center rounded-token-full border border-border bg-white/90 text-neutral-700 shadow-soft backdrop-blur-xl transition-token hover:border-accent/60 hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background dark:bg-black/70 dark:text-neutral-200"
