...
export default function Skills() {
  ...
  return (
    <div className="mt-20 space-y-8">
      <h2 className="text-3xl font-bold text-orange-700 dark:text-orange-300">🚀 My Skills</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
        {skills.map((skill, i) => (
          <div
            key={i}
            className="group bg-white dark:bg-zinc-800 border border-orange-300 dark:border-orange-600 rounded-xl p-4 flex flex-col items-center justify-center text-center font-semibold text-orange-700 dark:text-orange-300 shadow-md hover:shadow-xl transform transition-all duration-300 hover:scale-105 hover:bg-orange-50 dark:hover:bg-orange-700"
          >
